...
% TODO ausdenken woher die komischen werte kommen
...
% garnichts erkennbar
% spiegelungen von licht etc 
% bild bei dunkelheit und schlechtem licht mit guter dmap um zu zeigen das es nicht an der dunkelheit liegt

% spiegelungen im screen teilweise erkannt.
% winkel verbessert berechnung nicht wirkich
% beriche neben dem screen werden klar erkannt
% screen an sich nur dunkelheut und mismatches
% verschiedene winkel 45, 22,5 12,5 

% spiegelung und reflexion 
% reflektierte objekte teilweise erkannt 
% in abhängigkeit von der camera -> reflection plane + reflection plane -> obj
% generell sehr viele falschberechnungen
% 
