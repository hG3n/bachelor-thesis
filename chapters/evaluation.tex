...
\noindent
\textbf{Veränderung der \emph{SGBM} Block Größe:}\\
...
\hline
\end{tabular}
\caption{Ausgewertete Daten des Subimage Sit}
\label{tbl:distance_subimage}
\end{table}	

\noindent
Das im Rahmen dieses Tests genutzte Hindernis ist jenes aus den Tests der einzelnen Methoden. Wie aus Abbildung \ref{tbl:distance_subimage} ersichtlich wird hat eine Änderung der Blockgröße keine Auswirkungen auf die Erkennung des Objektes. Die berechneten Entfernungen werden erheblich von den Pixeln des Hintergrundes beeinflusst, was in den verzerrten berechneten Distanzen resultiert.\\
