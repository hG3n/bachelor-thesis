...
\begin{equation}
  \begin{aligned}
    ...
    \end{rcases}
    \begin{array}{c}
        X' = \dfrac{I_x - C_x}{d \cdot a + b}\\
        Y' = \dfrac{I_y - C_y}{d \cdot a + b}\\
        X' = \dfrac{f}{d \cdot a + b}\\\\
    \end{array}
  \end{aligned}
\end{equation}

% TODO parameter rückrechnung

% Invertierung der oben beschriebenen Rechnung
% Disparity Map kann somit aus 3d koordinaten zuruckgerechnet werden
